	...
	return (
		<div className="min-h-screen bg-gray-100 py-10">
			<div className="max-w-4xl mx-auto px-5">
				<h1 className="text-4xl font-bold mb-10 text-center text-gray-800">Timetable Generator</h1>
				<div className="bg-white shadow-lg rounded-2xl p-8 mb-10">
					...
					<div className="mb-6">
						<h2 className="text-2xl font-bold mb-4 text-gray-800">Preset Code</h2>
					...
					{subjects.map((subject, subjectIndex) => (
						<div key={subjectIndex} className="mb-8 p-6 bg-gray-50 border-4 border-gray-200 rounded-2xl shadow-md">
						...
						{subject.teachers.map((teacher, teacherIndex) => (
							...
							<input
								...
								value={teacher.name}
								onChange={(e) =>
								handleTeacherChange(subjectIndex, teacherIndex, "name", e.target.value)
								}
							/>
							<input
								className="flex-grow shadow appearance-none border border-gray-300 rounded-xl py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mr-2"
