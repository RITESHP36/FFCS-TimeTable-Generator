...
const PresetHelper = () => {
	...
	const presets = {
		"2021-BRS": "zyxwvu, tsrqpo, nmlkji, hgfdcb, a",
		"2022-BAI": "abcdefg, hijklmn, opqrstu, vwxyz",
	...
	return (
		<div className="bg-white p-6 rounded-lg shadow-lg  mx-auto">
			...
			{/* text if preset not found */}
			{notfound && (
				<div className="mt-6 p-4 bg-gray-100 rounded-md">
					<h4 className="text-xl font-semibold mb-2">Preset Not Found:</h4>
